...
class CretEvents : private mbed::NonCopyable<CretEvents>, public ble::Gap::EventHandler {
  ...
  public:
     ...
     */
    /*!
     * \fn virtual void CretEvents::onAdvertisingReport(const ble::AdvertisingReportEvent &event) override
    ...
    /*!
     * \fn virtual void onPeriodicAdvertisingReport(const PeriodicAdvertisingReportEvent &event) override
     * \brief Called when a scan returns a periodic advertising packet.
     */
    virtual void onPeriodicAdvertisingReport(const ble::PeriodicAdvertisingReportEvent &event) override;
    /*!
     * @}
     */
    /*!
